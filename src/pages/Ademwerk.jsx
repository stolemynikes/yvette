...
export default function Ademwerk() {
  ...
  return (
    <div className='ademwerk-container'>
        ...
        <div className='ademwerk-banner' ref={bannerRef}>
        ...
        <div className='ademwerk-text1' ref={text1Ref}>
        ...
        <div className='ademwerk-text2' ref={text2Ref}>
        ...
        <div className='ademwerk-text3 p5-10' ref={text3Ref}>
